...
const LandingPage = () => {
  ...
  const handleSearch = (e) => {
    e.preventDefault();
    navigate(
      `/search?location=${encodeURIComponent(searchLocation)}&date=${encodeURIComponent(searchDate)}`
    );
  };
    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Search thousands of parking spaces in your area with real-time availability
              </p>
            </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {loading && <p className="text-center text-gray-600">Loading parking spaces...</p>}
          {error && <p className="text-center text-red-600">{error}</p>}

          <div className="grid md:grid-cols-3 gap-8">
            {!loading && !error && featuredSpaces.length === 0 && (
              <p className="text-center text-gray-600 col-span-3">No parking spaces available.</p>
            )}
